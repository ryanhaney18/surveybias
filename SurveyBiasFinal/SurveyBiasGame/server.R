...
shinyServer(function(input, output, session) {
  ...
  observeEvent(input$runif,{
    output$text_example <- renderText({"Do you agree or disagree that it is hard for today's college graduates to have a bright future with the way things are today in the world?" })
  })
